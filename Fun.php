...
<ul>
<li><b>Dubsmash</b></li>
<li><b>Blind-Folded</b></td></li>
<li><b>Antrakshri</b></td></li>
<li><b>Mimickery</b></li>
<li><b>Dare to pick</b></li>
</ul></tr>
<tr style="height: 700px;"></tr>
</table></td>
<td><table><tr>
<?php
require "dbconnection.php";
$selQry="select e_id,e_name,e_date,e_time,e_fees,e_desc,e_img from fun_events";
...
echo "<table  style='background-color: white;width:1000px;'>";
       ...
       while($row=mysqli_fetch_assoc($result))// while($row=mysqli_fetch_array($result))//while($row=mysqli_fetch_array($result,MYSQL_ASSOC))
       {
           ...
           echo "<tr><td><img src='$path' width=200px height=300px alt=Image text/></td></tr>";
...
if(isset($_POST["done"]))
{
 ...
 if(isset($_POST["5001"]))
      {
        $selqry1="select e_fees,participants_no from fun_events where e_id=5001";
        ...
        $updqry1="update fun_events set participants_no=$n1 where e_id=5001";
 ...
 if(isset($_POST["5002"]))
      {
        $selqry2="select e_fees,participants_no from fun_events where e_id=5002";
        ...
        $updqry2="update fun_events set participants_no=$n2 where e_id=5002";
 ...
 if(isset($_POST["5003"]))
      {
        $selqry3="select e_fees,participants_no from fun_events where e_id=5003";
        ...
        $updqry3="update fun_events set participants_no=$n3 where e_id=5003";
 ...
 if(isset($_POST["5004"]))
      {
        $selqry4="select e_fees,participants_no from fun_events where e_id=5004";
        ...
        $updqry4="update fun_events set participants_no=$n4 where e_id=5004";
 ...
 if(isset($_POST["2005"]))
      {
        $selqry5="select e_fees,participants_no from fun_events where e_id=5005";
        ...
        $updqry5="update fun_events set participants_no=$n5 where e_id=5005";
